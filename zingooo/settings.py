"""
Django settings for zingooo project.
...
ALLOWED_HOSTS = ['.vercel.app','zingooo.live','www.zingooo.live']
...
INSTALLED_APPS = [
  ...
  'Attandanceapp.apps.AttandanceappConfig',
...
WSGI_APPLICATION = 'zingooo.wsgi.application'
